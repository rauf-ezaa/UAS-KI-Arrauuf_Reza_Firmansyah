...
class DetailProjectPolicy
{
    ...
    {
        return $user->can('view_any_detail::project');
    }
    ...
    {
        return $user->can('view_detail::project');
    }
    ...
    {
        return $user->can('create_detail::project');
    }
    ...
    {
        return $user->can('update_detail::project');
    }
    ...
    {
        return $user->can('delete_detail::project');
    }
    ...
    {
        return $user->can('delete_any_detail::project');
    }
     ...
     */
    public function replicate(User $user, DetailProject $detailProject): bool
    {
